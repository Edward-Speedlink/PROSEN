...
import { Bone as Drone, ArrowLeft, Send, AlertTriangle, MapPin } from "lucide-react"
            ...
            <FormGrid>
              <FormSection>
                ...
                <FormField>
                  ...
                  <StyledSelect name="priority" value={formData.priority} onChange={handleInputChange}>
                  ...
                  {formData.latitude && formData.longitude && (
                    <div className="location-overlay">
                      <div className="location-info">
                        <MapPin />
                        {formData.latitude.slice(0, 8)}, {formData.longitude.slice(0, 8)}
                      </div>
                    </div>
                  )}
                </MapContainer>
                <p style={{ fontSize: "12px", color: "#8D99AE", textAlign: "center", margin: "8px 0 0 0" }}>
