...
import { Car, Plus, Bone as Drone, Shield, AlertTriangle, Map, User, Settings, Flag, X } from "lucide-react"
...
const ReportStolenButton = styled(Button)`
  background-color: ${(props) => props.theme.colors.supportive.crimson};
  color: white;
  font-size: 12px;
  padding: ${(props) => props.theme.spacing.xs} ${(props) => props.theme.spacing.sm};
  
  &:hover {
    background-color: ${(props) => props.theme.colors.supportive.crimson}dd;
...
const QuickActionsCenter = styled.div`
  background: ${(props) => (props.theme.isDark ? props.theme.colors.primary.darkNavy : props.theme.colors.primary.deepBlue)};
  border-radius: ${(props) => props.theme.borderRadius.xl};
  padding: ${(props) => props.theme.spacing.xl};
  color: ${(props) => props.theme.colors.dark.text};
...
const RecentActivitySection = styled(Card)`
  ...
  .activity-header {
    ...
    h3 {
      ...
      letter-spacing: 1px;
      color: ${(props) =>
        props.theme.isDark ? props.theme.colors.dark.text : props.theme.colors.light.text};
      margin-bottom: ${(props) => props.theme.spacing.sm};
      position: relative;
...
const ModalCard = styled.div`
  background: ${(props) =>
    props.theme.isDark ? props.theme.colors.primary.darkNavy : props.theme.colors.light.cardBg};
  border-radius: ${(props) => props.theme.borderRadius.xl};
  padding: ${(props) => props.theme.spacing.xl};
  width: 400px;
  max-width: 90%;
  ...
  p {
    margin-bottom: ${(props) => props.theme.spacing.lg};
    color: ${(props) =>
      props.theme.isDark ? props.theme.colors.dark.textSecondary : props.theme.colors.light.textSecondary};
  }
...
const UserDashboard = () => {
  ...
  const [stolenModal, setStolenModal] = useState({ open: false, vehicle: null });


  // const handleReportStolen = (vehicleId) => {
  //   console.log(`Reporting vehicle ${vehicleId} as stolen`)
  //   // Add your stolen report logic here
  //   alert(`Vehicle ${vehicleId} has been reported as stolen. Authorities will be notified.`)
  // }
const handleReportStolen = (vehicle) => {
  setStolenModal({ open: true, vehicle });
};
              ...
              {vehicles.slice(0, 3).map((vehicle) => (
                <VehicleItem key={vehicle.id}>
                  ...
                  <div className="actions">
                    ...
                    <ReportStolenButton size="sm" onClick={() => handleReportStolen(vehicle)}>
                      <Flag />
                      Report Stolen
                    </ReportStolenButton>
                  </div>
  ...
  <ModalBackdrop>
    <ModalCard>
      <div className="close-btn" onClick={() => setStolenModal({ open: false, vehicle: null })}>
        <X />
      </div>
      <h2><AlertTriangle /> Confirm Report</h2>
      <p>
        Are you sure you want to report{" "}
        <strong>
          {stolenModal.vehicle.year} {stolenModal.vehicle.make} {stolenModal.vehicle.model} (
          {stolenModal.vehicle.plate})
        </strong>{" "}
        as stolen? Authorities will be notified immediately.
      </p>
      <div className="modal-actions">
        <Button variant="outline" onClick={() => setStolenModal({ open: false, vehicle: null })}>
          Cancel
        </Button>
        <Button
          variant="destructive"
          onClick={() => {
            console.log(`Vehicle ${stolenModal.vehicle.id} has been reported as stolen.`);
            // 🔴 TODO: Replace with actual API call
            setStolenModal({ open: false, vehicle: null });
          }}
        >
          Report Stolen
        </Button>
...
// // === Vehicle Item with "Report Stolen" button ===
// const VehicleItem = styled.div`
//   display: flex;
//   align-items: center;
//   justify-content: space-between;
...
//     props.theme.isDark
//       ? props.theme.colors.primary.darkNavy
//       : props.theme.colors.supportive.lightGray};
//   border-radius: ${(props) => props.theme.borderRadius.md};
//   border: 1px solid
//     ${(props) => (props.theme.isDark ? props.theme.colors.primary.deepBlue : "transparent")};
...
//         color: ${(props) =>
//           props.theme.isDark
//             ? props.theme.colors.dark.textSecondary
//             : props.theme.colors.light.textSecondary};
//         text-transform: uppercase;
//         letter-spacing: 1px;
//       }
//     }
...
//   display: grid;
//   grid-template-columns: 2fr 2fr 1fr; /* left = My Vehicles, middle = Quick Actions, right = Activity */
//   gap: ${(props) => props.theme.spacing.xxl};
//   margin-bottom: ${(props) => props.theme.spacing.xxl};
...
//   }
// `
// // This is the "content area" inside the layout
